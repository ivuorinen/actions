"""GENERATED — DO NOT EDIT. Input validation for the pre-commit action.
...
CHECKS = {
    "base-branch": check_branch_name,
    "commit_email": check_email,
    "commit_user": check_git_author_name,
    "pre-commit-config": check_file_path,
