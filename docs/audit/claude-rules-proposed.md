...
Extracted verbatim from the former `docs/audit/claude-rules-auditor-findings.md`
so this proposal artifact survives that file's migration into the findings store
