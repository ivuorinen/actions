"""GENERATED — DO NOT EDIT. Input validation for the prettier-lint action.
...
CHECKS = {
    ...
    "file-pattern": check_path_list,
    "ignore-file": check_file_path,
    "max-retries": check_numeric_range_1_10,
    "mode": check_mode_enum,
    "plugins": check_plugin_list,
    "prettier-version": check_semantic_version,
