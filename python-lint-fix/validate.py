"""GENERATED — DO NOT EDIT. Input validation for the python-lint-fix action.
...
CHECKS = {
    "autopep8-version": check_semantic_version,
    "email": check_email,
    "fail-on-error": check_boolean,
    "flake8-version": check_semantic_version,
    "max-retries": check_numeric_range_1_10,
    "python-version": check_semantic_version,
