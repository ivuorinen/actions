...
|----------------------|---------------------------------------|------------------------------------------|
| **`errors_count`**   | Number of formatting errors found     | `\${{ steps. .outputs.errors_count }}`   |
| **`lint_status`**    | Overall lint status (success/failure) | `\${{ steps. .outputs.lint_status }}`    |
| **`warnings_count`** | Number of formatting warnings found   | `\${{ steps. .outputs.warnings_count }}` |
